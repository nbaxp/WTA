...
public class ClosedXMLImportService : IImportExportService
{
    private readonly IStringLocalizer _localizer;

    public ClosedXMLImportService(IStringLocalizer localizer)
    {
    ...
    public virtual FileContentResult Export<TModel>(List<TModel> list, string? fileName = null)
    {
        ...
        //{
        //    column.Width = column.Cells().Max(cell => cell.GetFormattedString()!).Length * 20;
        //}
